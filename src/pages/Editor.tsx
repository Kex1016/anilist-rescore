...
function EditorPage() {
  ...
  const [nav, setNav] = useState<EditorPageParams | undefined>();
  ...
  if (!id || !type) return <div>Invalid entry</div>;

  return (
    // Section that fills the page
    <section className="flex justify-center items-center h-[calc(100vh-4rem)]">
          ...
          <Card className="w-full md:w-1/2 ml-auto">
            ...
            <CardContent className="flex flex-col gap-5">
                    ...
                    .map((line, i) => {
                      ...
                      return (
                        <p
                          key={i}
                          className={
                            "text-base mb-2" + (i === 0 ? "" : " line-clamp-2")
                          }
              ...
              <div className="flex flex-row gap-3 mx-4 justify-center">
                ...
                />
                <StatCard title="Status" value={originalEntry.current.status} />
                <StatCard
                  title="Episodes"
                  ...
                  userSettings.advancedScoring ? (
                        ...
                        return (
                          ...
                          >
                            ...
                            <Input
                              ...
                              value={
                                userSettings.scoreSystem === "POINT_10_DECIMAL"
                                  ? (entry.advancedScores[key] / 10).toString()
                    ...
                    <Input
                      ...
                      onChange={(e) => {
                        ...
                        if (isNaN(value)) return;
                        if (value < 0) return;
                        if (value > scoreSystemLookup[userSettings.scoreSystem])
                          return;
      ...
      >
        ...
        <div className="history-items overflow-y-auto">
          {
            // History
                  ...
                  >
                    <div className="flex flex-col">
                      <div className="flex flex-row gap-2 text-left items-end">
                        <p>
                          {
                            userList.entries[type][history.entryId].media.title
                              .userPreferred
                          }
                        </p>
                      ...
                      <div className="flex flex-row gap-2">
                        <div className="font-bold">
                          {userSettings.advancedScoring ? "Scores:" : "Score:"}
                        </div>
                        <div>
                          {userSettings.advancedScoring
        ...
        {userList.history[type].length > 0 && (
          ...
          >
            <Button
              onClick={() => {
                // TODO: Commit the changes to AniList
              }}
            >
              Commit all changes
            </Button>
